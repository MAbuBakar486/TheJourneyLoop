...
const CitiesPage = () => {
  ...
  return (
    <div className="container" style={{marginTop:"90px"}}>
      <h2 className="text-center fw-bold mb-4 mt-5" style={{color:"#0C3A2E", fontFamily:"Playfair Displays"}}>Explore Cities</h2>
    ...
    >
      ...
      >
        Detail
                      ...
                      {/* <button className="btn book-btn w-100 mb-3" style={{color:"white",backgroundColor:"#0C3A2E"}} onClick={() => handleBook(tour)}>
                        Book Tour
                      </button> */}
                    </div>
                  </div>
